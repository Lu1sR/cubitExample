...
import 'package:loading_animation_example/side_menu/mude_dashboard_layout/dashboard.dart';
import 'package:loading_animation_example/side_menu/mude_dashboard_layout/menu.dart';
...
class _MenuDashboardLayoutState extends State<MenuDashboardLayout>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: BlocProvider<SidemenuBloc>(
        create: (context) => SidemenuBloc(onMenuTap: onMenuTap),
        child: Stack(
          children: <Widget>[
            BlocBuilder<SidemenuBloc, SidemenuState>(
              builder: (context, SidemenuState navigationState) {
                return Menu(
  ...
  int findSelectedIndex(SidemenuState navigationState) {
    if (navigationState is MainDashboard) {
      return 0;
